...
public class RunD1 {
    ...
    static int sizeOfGenes = 10; //num output
    static int sizeOfRules = 6; //inputindiv size
    static double mutateRate = 0.01;
    
    //change mutationRate, populationsize to get data for graphs

    static String inputFile = "data1.txt";
    static String pathToCreate = "src/CSV_Data1/Data1,PopSize-" + populationSize + ",Genes-" + sizeOfGenes
    ...
    public static void main(String[] args) {
       ...
       System.out.println("Population size-" + populationSize + ",Genes-" + sizeOfGenes
        ...
        System.out.println("Dataset-1 Result: ");
